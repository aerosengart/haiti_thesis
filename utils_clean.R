...
## -------------------------------------- ##
## get haiti population ## use sum of population in departments 
get.haiti.pop <- function(){
  pop <- sum(c(746236, 1727524, 4029705, 728807, 1067177, 774976, 
               342525, 393967, 632601, 468301)) 
  return(pop)
}
...
get.mspp.agg.data <- function(){
  ...
  allDat <- read_csv("Data/haiti-data-from-2010-10-to-2019-01.csv", skip = 1, col_names = c("date_sat_orig", "report", "Artibonite", "Centre", "Grand_Anse", "Nippes", "Nord", "Nord_Est", "Nord_Ouest", "Ouest", "Sud", "Sud_Est"), col_types = "cciiiiiiiiii")
